...
export interface ApiCollectionCollection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    coverImage: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiMediaItemMediaItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    forSale: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiSiteSite extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    theme: Schema.Attribute.String & Schema.Attribute.DefaultTo<'default'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTransactionTransaction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    subscription: Schema.Attribute.Relation<
      ...
      'api::subscription.subscription'
    >;
    type: Schema.Attribute.Enumeration<['subscription', 'media_purchase']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    stripeConnectId: Schema.Attribute.String;
    stripeCustomerId: Schema.Attribute.String;
    subscriptions: Schema.Attribute.Relation<
      'oneToMany',
      'api::subscription.subscription'
